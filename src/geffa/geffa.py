...
from typing import Literal, Callable, Any, Pattern, TextIO, TypeVar, cast
...
def _parse_fasta(txt: str) -> dict[str, Seq]:
    # Parse a FASTA string into a dict with the keys as the contig names and
    # the values as the sequences.
